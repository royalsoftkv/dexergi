Contributing to DEXERGI Core
============================

The DEXERGI Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/dexergi-project/dexergi/blob/master/doc/translation_process.md)
...
The following applies to code changes to the DEXERGI Core project, and is not to be
confused with overall DEXERGI Network Protocol consensus changes.

Whether a pull request is merged into DEXERGI Core rests with the project merge
...
Patches that change DEXERGI consensus rules are considerably more involved than
...
Where a patchset proposes to change the DEXERGI consensus, it must have been
...
The project leader is the release manager for each DEXERGI Core release.
