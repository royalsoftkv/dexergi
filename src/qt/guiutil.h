...
/** Utility functions used by the DEXERGI Qt UI.
 */
namespace GUIUtil
{
...
// Render DEXERGI addresses in monospace font
...
// Parse "dexergi:" URI into recipient object, return true on successful parsing
