...
/* DEXERGI GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "DEXERGI"
#define QAPP_ORG_DOMAIN "dexergi.org"
#define QAPP_APP_NAME_DEFAULT "DEXERGI-Qt"
#define QAPP_APP_NAME_TESTNET "DEXERGI-Qt-testnet"
