...
static Checkpoints::MapCheckpoints mapCheckpoints = 
    ...
    (0, uint256("00000567e3bc4d3528f99d93981418a7c7b9e9e0eeb3cbdcf56a948faf29c6df"))
    ...
    (21000, uint256("cd134c2ee4e146df0746a08b34c43431969456f522cf2dd23c94ee659afc3d58"))
    (27000, uint256("86ed296a0e22f4f1cc52fffe3e002f895af76f1d4953b5eb747a10d0917c7e99"))
    (35000, uint256("14eefbe04c24581fec13b845f0762c7d489accd3aabc2ed25b81b17bf8b37ead"))
    (42000, uint256("ed9e36ec30835519c71765d8109ba84d7cfa650cbba004a22d99782cadfbfe03"))
    (47000, uint256("60395afa411128e3a1ffc2f32118092d24cedd9137264a8ddc8e816e7cd65883"))
    (53000, uint256("71146f40defeb296d2a21d95ce7a520f03851fcf12d6468ce101bba613e48e7c"))
    (58000, uint256("3d92785718696e6b09b40bcea34c210f1e52948208066fbdb9a80ffb9fff9100"));
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1567161385, // * UNIX timestamp of last checkpoint block
    115947,    // * total number of transactions between genesis and last checkpoint
...
public:
    CMainParams()
    {
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "The contribution of each proposed renewable energy technology, Energy Statements within London";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1561020077;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 89124;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000567e3bc4d3528f99d93981418a7c7b9e9e0eeb3cbdcf56a948faf29c6df"));
...
public:
    CTestNetParams()
    {
        ...
        genesis.nTime = 1561020161;
        genesis.nNonce = 693292;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x000002da8efe2e18603e581ad702ea204acc6365c6f2876ad32a34dee393e6b5"));
...
public:
    CRegTestParams()
    {
        ...
        genesis.nNonce = 1980678;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x0000023de28f889d04931baa573953f72dd6412a0e38a4c26c43e040bc77a13b"));
