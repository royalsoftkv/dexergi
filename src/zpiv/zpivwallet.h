...
#ifndef DEXERGI_ZDEXRWALLET_H
#define DEXERGI_ZDEXRWALLET_H
...
public:
    CzDEXRWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZDEXR(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZDEXR(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
